...
NSE_STOCKS = [
    ...
    'LT.NS', 'MARUTI.NS', 'BAJAJ-AUTO.NS', 'SUNPHARMA.NS', 'ASIANPAINT.NS',
    'WIPRO.NS', 'TECHM.NS', 'ULTRACEMCO.NS', 'POWERGRID.NS', 'JSWSTEEL.NS',
    'BHARTIARTL.NS', 'SBILIFE.NS', 'INDUSIND.NS', 'AXIS.NS', 'BAJAJFINSV.NS',
    'TATACONSUM.NS', 'TITAN.NS', 'HINDALCO.NS', 'TATASTEEL.NS', 'APOLLOHOSP.NS',
    'ONGC.NS', 'NTPC.NS', 'IOC.NS', 'GAIL.NS', 'BPCL.NS',
    'COALINDIA.NS', 'HEROMOTOCO.NS', 'M&M.NS', 'TATAPOWER.NS', 'EICHERMOT.NS',
    'ADANIPORTS.NS', 'ADANIGREEN.NS', 'ADANIPOWER.NS', 'ADANITRANS.NS', 'GODREJCP.NS',
    'BRITANNIA.NS', 'MARICO.NS', 'NESTLEIND.NS', 'DABUR.NS', 'COLPAL.NS',
    'MEESHO.NS', 'PAGEIND.NS', 'BERGEPAINT.NS', 'DIVISLAB.NS', 'LUPIN.NS',
    'DRREDDY.NS', 'CIPLA.NS', 'BOSCHLTD.NS', 'AMBUJACEM.NS', 'SHREECEM.NS',
    'GLAND.NS', 'ALKEM.NS', 'CADILAHC.NS', 'AUROPHARM.NS', 'DIVI.NS',
    'NATIONALUM.NS', 'JINDALSTEL.NS', 'SAIL.NS', 'VEDANTA.NS', 'RATNAMANI.NS',
    'THERMAX.NS', 'KIRLOSKAR.NS', 'GMRINFRA.NS', 'IRFC.NS', 'IDFCFIRSTB.NS',
    'MINDTREE.NS', 'INFIBEAM.NS', 'NAUKRI.NS', 'ZOMATO.NS', 'PAYTM.NS',
    'NYKAA.NS', 'MANYAVAR.NS', 'RELAXO.NS', 'BATA.NS', 'POLYCAB.NS',
    'HAVELLS.NS', 'SIEMENS.NS', 'SCHNEIDER.NS', 'ABB.NS', 'CROMPTON.NS',
    'GRAPHITE.NS', 'CUMMINSIND.NS', 'LASGRUP.NS', 'MEDPLUS.NS', 'MUTHOOTFIN.NS',
]
